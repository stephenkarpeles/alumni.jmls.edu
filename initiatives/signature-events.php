...
<?php
$tpTitle="Signature Events Transforms Lives | The Office of Alumni Relations &amp; Development";
// $pgDesc="";
// $pgKeywords="";
?>
			...
			<div class="grid-col bp3-col-3-4 pull-right-above-bp1">	
				...
				<article class="main">	
				  ...
				  <?php include('../includes/breadcrumbs.php'); ?>
					...
					<h1 class="page-header">Signature Events Transforms Lives</h1>
					<p class="featured-text">Each year, The John Marshall Law School presents a number of events that are geared to stimulate intellectual engagement on a variety of legal topics. These Signature Events address some of the most interesting issues of our time, and they certainly have a powerful impact on all participants and attendees.</p>
