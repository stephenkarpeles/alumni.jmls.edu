...
$tpTitle="Board of Directors | The John Marshall Law School - Office of Alumni Relations &amp; Development";
// $pgDesc="";
?>
			...
			<div class="grid-col bp3-col-3-4 pull-right-above-bp1">	
				...
				<article class="main">	
				  ...
				  <?php include('../includes/breadcrumbs.php'); ?>	
					...
					<h3 class="mar-top-small mar-bot-small-alt">Board of Directors Officers</h3>
					...
					<h3 class="mar-top-small mar-bot-small-alt">Emeritus Members</h3>

					<div class="grid-wrap">
						<div class="grid-col bp2-col-1-2">
							<p class="mar-bot-smallest">Hon. Everette A. Braden, '61</p>
							<p class="mar-bot-smallest">Hon. Cheryl D. Cesario, '81</p>
							<p class="mar-bot-smallest">Umberto S. Davi, '82</p>
							<p class="mar-bot-smallest">Celia G. Gamrath, '94</p>
							<p class="mar-bot-smallest">Hon. Sheldon C. Garber, '64</p>
							<p class="mar-bot-smallest">Paula H. Holderman, '79</p>
						</div>
						<div class="grid-col bp2-col-1-2">
							<p class="mar-bot-smallest">Ralph Muentzer, '66</p>
							<p class="mar-bot-smallest">Hon. Jesse G. Reyes, '82</p>
							<p class="mar-bot-smallest">Geraldine C. Simmons, '81</p>
							<p class="mar-bot-smallest">Hon. James Fitzgerald Smith, 75</p>
							<p class="mar-bot-smallest">Donald G. Weiland, '80</p>
							<p class="mar-bot-smallest">E. Steven Yonover, '77</p>
						</div>
					</div><!-- .grid-wrap -->

					<h3 class="mar-top-medium mar-bot-small-alt">Board Members</h3>
						...
						<div class="grid-wrap">
							...
							<div class="grid-col bp2-col-1-2">
								...
								<p class="mar-bot-smallest">Letitia Spunar-Sheats, '71</p>
								<p class="mar-bot-smallest">Matthew S. Sims '09</p>
								<p class="mar-bot-smallest">Hon. James F. Smith '75</p>
								<p class="mar-bot-smallest">Mariyana T. Spyropoulos '96</p>
								<p class="mar-bot-smallest">Marilyn V. Uzemack, '77</p>
