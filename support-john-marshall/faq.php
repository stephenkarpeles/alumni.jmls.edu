...
$tpTitle="FAQs | The John Marshall Law School - Office of Alumni Relations &amp; Development";
// $pgDesc="";
?>
				...
				<article class="main">
				  ...
				  <?php include('../includes/breadcrumbs.php'); ?>		
					...
					<div class="accordion-view">
						<span class="accordion-expand">Show All Answers</span>
						&nbsp;|&nbsp;
						<span class="accordion-collapse">Hide All Answers</span>
					</div>
					...
					<div class="accordion">
					  ...
					  <div class="accordion-content visually-hidden">
					    ...
					    <ul>
					    	<li>Fair market value</li>
								<li>Existence of restrictions</li>
								<li>Reservations</li>
								<li>Easements</li>
								<li>Other limitations</li>
								<li>Marketability of the property</li>
								<li>Clear title</li>
								<li>Location</li>
								<li>Environmental assessment</li>
								<li>Cost to John Marshall associated with ownership</li>
								<li>Likelihood of use for John Marshall’s educational mission</li>
					    </ul>
					  </div>
					  ...
					  <div class="accordion-content visually-hidden">
					    <p>You can make a gift by check, online, or over the phone.</p>
							...
							<p>Mail checks to:<br>
							The John Marshall Law School Office of Development<br>
							315 S. Plymouth Court<br>
							Chicago, Illinois 60604</p>

							<p>By phone: 312.386.2871</p>
							<p>Online: <a class="bold" href="http://www.jmls.edu/give" target="_blank">Give to John Marshall Now</a></p>
					  </div>
					  ...
					  <div class="accordion-content visually-hidden">
					    ...
					    Office of Development<br>
							...
							<p>Phone: 312.360.2663<br>
							Email: <a class="bold" href="mailto:development@jmls.edu">development@jmls.edu</a></p>
					  </div>
