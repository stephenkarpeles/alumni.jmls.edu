...
<!-- Header -->
<?php include('../../includes/header-pledge-form.php'); ?>
				  ...
				  <?php include('../../includes/breadcrumbs.php'); ?>		
					...
					<div class="pledge-form">	
						...
						<form class="jotform-form" action="http://submit.jotform.us/submit/41616494900152/" method="post" name="form_41616494900152" id="41616494900152" accept-charset="utf-8">
						  ...
						  <div class="form-all">
						    <ul class="form-section">
						      ...
						      <li class="form-line" id="id_6">
						        <label class="form-label-top" id="label_6" for="input_6"> Graduating Class of </label>
						        <div id="cid_6" class="form-input-wide">
						          <select class="form-dropdown" style="width:150px" id="input_6" name="q6_graduatingClass">
						            <option value="">  </option>
						        ...
						        <div id="cid_8" class="form-input-wide">
						          <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
						            <tr>
						              <td colspan="2">
						                <span class="form-sub-label-container">
						                  <input class="form-textbox form-address-line" type="text" name="q8_address8[addr_line1]" id="input_8_addr_line1" />
						            ...
						            <tr>
						              <td width="50%">
						                <span class="form-sub-label-container">
						                  <input class="form-textbox form-address-city" type="text" name="q8_address8[city]" id="input_8_city" size="21" />
						                  <label class="form-sub-label" for="input_8_city" id="sublabel_8_city"> City </label>
						                </span>
						              </td>
						              <td>
						                <span class="form-sub-label-container">
						                  <input class="form-textbox form-address-state" type="text" name="q8_address8[state]" id="input_8_state" size="22" />
						            ...
						            <tr>
						              <td width="50%" function zip(){var iterator=Prototype.K,args=$A(arguments);if(Object.isFunction(args.last())) iterator=args.pop();var collections=[this].concat(args).map($A);return this.map(function(value,index){return iterator(collections.pluck(index));});}>
						                <span class="form-sub-label-container">
						                  <input class="form-textbox form-address-postal" type="text" name="q8_address8[postal]" id="input_8_postal" size="10" />
						                  <label class="form-sub-label" for="input_8_postal" id="sublabel_8_postal"> Postal / Zip Code </label>
						                </span>
						              </td>
						              <td>
						                <span class="form-sub-label-container">
						                  <select class="form-dropdown form-address-country" name="q8_address8[country]" id="input_8_country">
						      ...
						      <li class="form-line" id="id_9">
						        <label class="form-label-top" id="label_9" for="input_9"> E-Mail </label>
						        <div id="cid_9" class="form-input-wide">
						          <input type="email" class=" form-textbox validate[Email]" id="input_9" name="q9_email9" size="40" value="" />
						        </div>
						      </li>
						      <li class="form-line" id="id_21">
						        <label class="form-label-top" id="label_21" for="input_21"> Phone: </label>
						        <div id="cid_21" class="form-input-wide">
						          <input type="number" class="form-number-input  form-textbox" id="input_21" name="q21_phone" style="width:260px" size="30" value="" data-type="input-number" />
						        </div>
						      </li>
						      <li class="form-line" id="id_11">
						        <div id="cid_11" class="form-input-wide">
						          <div id="text_11" class="form-html">
						            <p>Your company or firm may offer a matching gift program. Matching gifts are an excellent way to double or even triple your contribution. For further information on matching gifts, please contact your personnel department or contact a Development Office staff member at 312.360.2663 or email <a href="mailto:development@jmls.edu">development@jmls.edu</a>.</p>
						          </div>
						        </div>
						      </li>
						      <li class="form-line" id="id_12">
						        <label class="form-label-top" id="label_12" for="input_12"> How much would you like to pledge? </label>
						        <div id="cid_12" class="form-input-wide">
						          <span class="form-sub-label-container">
						            <input type="number" class="form-number-input  form-textbox" id="input_12" name="q12_howMuch" style="width:60px" size="5" value="" data-type="input-number" />
						            <label class="form-sub-label" for="input_12"> Please provide dollar amount </label>
						          </span>
						        </div>
						      </li>
						      <li class="form-line" id="id_13">
						        ...
						        <div id="cid_13" class="form-input-wide">
						          <select class="form-dropdown" style="width:150px" id="input_13" name="q13_howOften">
						            <option value="">  </option>
						      ...
						      <li class="form-line" id="id_14">
						        <label class="form-label-left" id="label_14" for="input_14"> over </label>
						      ...
						      <li class="form-line" id="id_22">
						        ...
						        <div id="cid_22" class="form-input-wide">
						          <input type="text" class="form-textbox" data-type="input-textbox" id="input_22" name="q22_eachPayment22" value="" size="20" />
						        </div>
						      </li>
						      <li class="form-line" id="id_16">
						        ...
						        <div id="cid_16" class="form-input-wide">
						          <span class="form-sub-label-container">
						            <select class="form-list" style="width:400px" id="input_16" name="q16_myPledge[]" size="8" multiple="multiple">
						              ...
						              <option value="Center for Tax Law &amp; Employee Benefits"> Center for Tax Law &amp; Employee Benefits </option>
						              <option value="Center for Information Technology &amp; Privacy Law"> Center for Information Technology &amp; Privacy Law </option>
						              <option value="Center for Intellectual Property Law"> Center for Intellectual Property Law </option>
						              <option value="Center for International Law"> Center for International Law </option>
						              <option value="Center for Real Estate Law"> Center for Real Estate Law </option>
						              <option value="China IP Study Abroad Program"> China IP Study Abroad Program </option>
						              <option value="Chinese IP Resource Center"> Chinese IP Resource Center </option>
						              <option value="Czech/Slovak Legal Institute"> Czech/Slovak Legal Institute </option>
						              <option value="Fair Housing Legal Support Center &amp; Clinic"> Fair Housing Legal Support Center &amp; Clinic </option>
						              <option value="Scholarship General Fund"> Scholarship General Fund </option>
						              <option value="Switzerland Study Abroad Program"> Switzerland Study Abroad Program </option>
						      ...
						      <li class="form-line" id="id_17">
						        <label class="form-label-top" id="label_17" for="input_17"> If other, please describe what your pledge will support: </label>
						  ...
						  <input type="hidden" id="simple_spc" name="simple_spc" value="41616494900152" />
						  <script type="text/javascript">
						  document.getElementById("si" + "mple" + "_spc").value = "41616494900152-41616494900152";
						  </script>
						</form>
