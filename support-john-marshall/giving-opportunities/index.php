			...
			<div class="grid-col bp3-col-3-4 pull-right-above-bp1">	
				...
				<article class="main">
				  ...
				  <?php include('../../includes/breadcrumbs.php'); ?>		
					...
					<p><strong><a href="#opp-7">Make a Pledge</a></strong><br>
					...
					<p><strong><a href="#opp-8">Gifts of Appreciated Securities</a></strong><br>
					...
					<p><strong><a href="#opp-9">Planned Gifts</a></strong><br>
					...
					<p><strong><a href="#opp-10">Cy Pres Award</a></strong><br>
